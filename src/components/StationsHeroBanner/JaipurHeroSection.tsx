      ...
      <div className="mx-auto md:mx-8 px-6 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            ...
            >
              Parents Arriving Alone at Jaipur Railway Station?
            </h1>
            ...
            >
              <a
                ...
                className="group inline-flex items-center justify-center gap-2 rounded-xl bg-green-600 text-white px-6 py-3.5 text-lg font-semibold hover:bg-green-700 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-0.5"
              >
              ...
              <a
                href="https://wa.me/919910646415?text=Hi%2C%20I%20need%20parent%20pickup%20from%20Jaipur%20Railway%20Station%20(JP).%20Please%20share%20details."
                target="_blank"
          ...
          <div className="order-1 lg:order-2 flex justify-center animate-scale-in">
            <div className="relative w-full max-w-md lg:max-w-lg">
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                <Image
                  src="/newdelhfinal.png" // You can replace this with a Jaipur-specific image later
                  alt="Care companion assisting an elderly parent at Jaipur Railway Station"
                  width={800}
                  height={800}
