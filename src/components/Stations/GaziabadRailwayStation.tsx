...
export const metadata: Metadata = {
    ...
    description:
        "Reliable parent pickup from Ghaziabad Railway Station (GZB). Background-verified Care2Home companions ensure safe doorstep drop with live WhatsApp updates. Book now.",
};

export default function GhaziabadRailwayStationPage() {
    const whatsappNumber = "919910646415";
    const stationCode = "GZB";
    const stationName = "Ghaziabad Railway Station";
    ...
    return (
        <div className="min-h-screen bg-background">
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <h1 className="text-3xl md:text-5xl font-bold text-primary mb-4 tracking-tight text-balance">
                            Parents Arriving Alone at Ghaziabad Railway Station?
                        </h1>
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground leading-relaxed mb-6 text-balance">
                            ...
                            and safely drop them inside their home in Delhi NCR.
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 text-primary">
                            Why Care2Home Works Best for Ghaziabad (GZB)
                        </h2>
                                ...
                                <CardContent className="pt-6">
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm text-muted-foreground leading-relaxed">
                                            ...
                                            travellers—especially at crowded stations.
                                        </p>
                                    </div>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="border-2">
                                <CardContent className="pt-6">
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm text-muted-foreground leading-relaxed">
                                            Get real-time updates (status and location) on WhatsApp, so you always
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto prose prose-lg">
                        <h2 className="text-2xl md:text-3xl font-bold mb-6 text-primary">
                            Hassle-Free Parent Pickup Service at Ghaziabad Railway Station
                        </h2>

                        <p className="text-muted-foreground leading-relaxed mb-4">
                            Ghaziabad Railway Station (GZB) is one of the busiest stations in the NCR region.
                            For elderly passengers, navigating long platforms, foot overbridges, crowds, and
                            luggage after a tiring journey can be challenging.
                        </p>

                        <p className="text-muted-foreground leading-relaxed mb-4">
                            Care2Home makes arrivals smooth and safe. Our companion tracks the train, reaches
                            the platform in advance, and receives your parent near their coach. We assist with
                            luggage, help them move comfortably through the station, and arrange a safe ride to
                            their home in Delhi NCR.
                        </p>

                        <p className="text-muted-foreground leading-relaxed mb-4">
                            Our promise is simple: your parent is never left alone. From platform pickup to
                            doorstep drop, the companion stays with your parent and supports every step—walking
                            support, wheelchair support when needed, and settling in comfortably at home.
                        </p>

                        <p className="text-muted-foreground leading-relaxed mb-6">
                            Whether your parents are arriving early morning or late night, we share live WhatsApp
                            updates so you have complete peace of mind—even when you’re in another city.
                        </p>
                ...
                <div className="container mx-auto px-4">
                    <div className="max-w-3xl mx-auto text-center">
                        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-balance">
                            Book Parent Pickup from Ghaziabad Railway Station (GZB)
                        </h2>
            ...
            <StickyButton buttonTitle="📞 Call Now | GZB Parent Pickup | 24/7" />
        </div>
    );
}
