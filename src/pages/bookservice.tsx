...
export default function BookService() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    //       arrival_type: formData.arrivalType,
    //       flight_train_number: formData.flightTrainNumber,
    //       arrival_time: arrivalDateTime.toISOString(),
    //       home_address: formData.homeAddress,
    //       special_needs: formData.specialNeeds,
    //       emergency_contact: formData.emergencyContact,
    //       booking_email: formData.bookingEmail,
    //       booking_phone: formData.bookingPhone
    //     }
    //   ]);
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-6">
              Thank you for trusting Care2Home. We have received your booking request and our team will contact you shortly to confirm the details.
            </p>
            <p className="text-gray-600 mb-8">
              You will receive a confirmation call within 2 hours. We will share your Care Companion&apos;s details before the journey begins.
            </p>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <Card>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Parent&apos;s Information</h3>
              <Input
                label="Parent's Name"
                name="parentName"
                type="text"
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <Input
                  label={formData.arrivalType === 'Airport' ? 'Flight Number' : 'Train Number'}
                  name="flightTrainNumber"
                  type="text"
                  required
                  value={formData.flightTrainNumber}
                  onChange={handleChange}
                  placeholder={formData.arrivalType === 'Airport' ? 'e.g., AI 101' : 'e.g., 12345'}
                />
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <p className="text-sm text-blue-900">
                <strong>Note:</strong> This is a booking request. Our team will call you within 2 hours to confirm details and payment. No payment is required now.
              </p>
            </div>
